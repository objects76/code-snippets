...
var l2i = {
  ...
  dropDb(dbName) {
    ...
    request.onsuccess = function (event) {
      l2i.consoles.original.log("logs2indexeddb successfully cleared and dropped");
    };
    request.onerror = function () {
      l2i.consoles.original.log("logs2indexeddb error when drop database");
    };
  },
  ...
  debug: {
    ...
    processWriteTest: function (db, n) {
      ...
      alert(
        "The test can take a lot of time (1-2 minutes). The browser can be locked duting the test. Ready to launch?"
      );
    ...
    testFinished: function () {
      ...
      var diff =
        ...
        (l2i.debug.startTime.getMinutes() * 60 + l2i.debug.startTime.getSeconds());
      var mean = diff / n;
      ...
      l2i.dropDb("logs2indexeddb_test");
    },
    /**
     * @private
     */
...
(() => {
  l2i.init(() => {
    l2i.on(() => console.log("l2i initialized"));
  });
})();
